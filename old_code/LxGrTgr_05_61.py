...
### imports ####################################
version = "0.0.5.61"
version_notes = "0.0.5.61 - Bug fixes - clausal subjects, NNP + NN != nn+npremod"
...
def complexity(token,sent):
	...
	if token.cat7 in ["vcomp"] and token.cat2 not in ["nonfinite"]: #if a finite clause comes after the verb <why did we do this?>; removed on 2025-02-09: and token.idx > token.headidx
...
# printer(tag("That he survived the fall suprised everyone."), verbose=True) #correct
