...
### imports ####################################
version = "0.0.5.39"
version_notes = "0.0.5.39 - work on attr+npremod"
...
def semiModalAdjust(token,sent): #adjust tags based on semimodals
	...
	#need to fix "gonna", finish BE modals


	#if token.idx >= 2 and " ".join(sent[token.idx-2:token.idx]) in semiModalL: #deal with two-word phrasal modals first:
	### START HERE!!! ###
