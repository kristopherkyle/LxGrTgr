...
### imports ####################################
version = "0.0.5.48"
version_notes = "0.0.5.48 - work on multi-word adverbs and multi-word infinitives"
		...
		if token.deprel in ["ccomp","csubj","xcomp"]: 
			...
			if sent[token.headidx].deprel in ["pobj"]:
				...
				if nGramMiddle(sent[token.headidx],sent,1,0) in ["in case"]: #multiword adverbial
					...
					sent[token.headidx+1].cat1  = "csphrsl"
					sent[token.headidx+1].cxtag = None
				elif nGramMiddle(sent[token.headidx],sent,1,1) in ["in order to"]:
					token.cat5 = "advlcls"
					sent[token.headidx].lxgrtag  = "tophrs"
					sent[token.headidx].cat1  = "tophrs"
					sent[token.headidx-1].lxgrtag  = "tophrs" #convert to 
					sent[token.headidx-1].cat1  = "tophrs"
					sent[token.headidx-1].cxtag = None
					sent[token.headidx+1].lxgrtag  = "to" #convert to 
					sent[token.headidx+1].cat1  = "tophrs"
					sent[token.headidx+1].cxtag = None
					...
					sent[token.headidx-1].cat1  = "csphrsl"
					sent[token.headidx-1].cxtag = None
					sent[token.headidx-2].lxgrtag  = "csphrsl" #convert to 
					sent[token.headidx-2].cat1  = "csphrsl"
					sent[token.headidx-2].cxtag = None
					sent[token.headidx+1].lxgrtag  = "csphrsl" #convert to 
					sent[token.headidx+1].cat1  = "csphrsl"
					sent[token.headidx+1].cxtag = None
...
#minor issues (change tag to cs) TO DO!!!
