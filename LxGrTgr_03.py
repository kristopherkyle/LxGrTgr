...
### imports ####################################
version = "0.0.3"
version_notes = "0.0.3 - More bug fixes on 20221203; Tags follow discussions with Doug, Randi, and Jesse (with a few tweaks)."
...
def that_wh(token,sent): #tweaked version
	...
	elif token.word.lower() in ["which","who","whom","whose","what","how","where","why","when"] and token.deprel in ["nsubj","mark","attr","advmod","dobj"]:
