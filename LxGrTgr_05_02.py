...
### imports ####################################
version = "0.0.5.2"
version_notes = "0.0.5.2 - Start integrating Biber et al.'s complexity Tags. Fixed bugs related to reldel, vcomp"
...
### Remaining issues:
# printer(tag("yeah, I think I probably could")) #PROBLEM: Should be verb+that+ccomp. But, "could" is not being counted as a main verb, which is throwing everything off.
